...
import run_sl_p1_pairwise_only as legacy_entry
...
class RunStage05P1PairwiseOnlyTests(unittest.TestCase):
    def test_main_accepts_legacy_args_and_shows_migration_message(self):
        ...
        self.assertIn('run_sl_p1_pairwise_only.py is deprecated.', message)
        self.assertIn('python run_sl_p1_only.py --run-name <name>', message)
