...
import run_sl_p1_only as p1_only
import sl_current_defaults as sl_defaults


REPO_ROOT = Path(__file__).resolve().parent.parent
LOADER_AB_ROOT = REPO_ROOT / 'logs' / 'sl_loader_ab'
LOADER_AB_ROOT.mkdir(parents=True, exist_ok=True)

DEFAULT_PROTOCOL_ARM = sl_defaults.CURRENT_PRIMARY_PROTOCOL_ARM
DEFAULT_RANK_BUDGET_RATIO = 0.15
DEFAULT_OPP_BUDGET_RATIO = 0.03
DEFAULT_DANGER_BUDGET_RATIO = 0.10
DEFAULT_VAL_FILE_BATCH_SIZE = sl_defaults.DEFAULT_VAL_FILE_BATCH_SIZE
DEFAULT_VAL_PREFETCH_FACTOR = sl_defaults.DEFAULT_VAL_PREFETCH_FACTOR
