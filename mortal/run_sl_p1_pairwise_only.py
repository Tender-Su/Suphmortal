...
DEPRECATION_MESSAGE = """
run_sl_p1_pairwise_only.py is deprecated.
...
Use run_sl_p1_only.py instead:
  python run_sl_p1_only.py --run-name <name>
  python run_sl_p1_only.py --run-name <name> --continue-to-winner-refine
  python run_sl_p1_only.py --run-name <name> --continue-to-ablation
""".strip()
