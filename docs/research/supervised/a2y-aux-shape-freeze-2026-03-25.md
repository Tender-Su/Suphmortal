...
> This note freezes the internal shapes for the `A2y` auxiliary-head line.
> Current mainline context lives in `docs/agent/mainline.md` and `docs/research/supervised-evolution.md`.
...
- micro-AB run dir:
  [logs/sl_fidelity/sl_fidelity_a2y_internal_mix_micro1s_20260324_224456](/C:/Users/numbe/Desktop/MahjongAI/logs/sl_fidelity/sl_fidelity_a2y_internal_mix_micro1s_20260324_224456)
- corrected summary:
  [final_summary_policy_corrected.json](/C:/Users/numbe/Desktop/MahjongAI/logs/sl_fidelity/sl_fidelity_a2y_internal_mix_micro1s_20260324_224456/final_summary_policy_corrected.json)
- raw launcher log:
  [launcher.stdout.log](/C:/Users/numbe/Desktop/MahjongAI/logs/sl_fidelity/launch_a2y_internal_mix_micro_20260324_224454/launcher.stdout.log)
...
- the old `P1 solo` evidence came from the historical `sl_fidelity_main` protocol pool rather than the new post-leakage `A2y` mainline
...
- `policy_quality` uses `recent_policy_loss` as the comparison loss:
  [run_sl_fidelity.py](/C:/Users/numbe/Desktop/MahjongAI/mortal/run_sl_fidelity.py#L537)
- entry summaries still record `full_recent_loss`, but also record `recent_policy_loss`:
  [run_sl_fidelity.py](/C:/Users/numbe/Desktop/MahjongAI/mortal/run_sl_fidelity.py#L669)
- round ranking stores the real comparison field as `comparison_recent_loss`:
  [run_sl_fidelity.py](/C:/Users/numbe/Desktop/MahjongAI/mortal/run_sl_fidelity.py#L923)
- `P1 solo` survivor gating compares family winner vs protocol-local `CE-only` using that comparison loss plus old-regression guardrail:
  [run_sl_fidelity.py](/C:/Users/numbe/Desktop/MahjongAI/mortal/run_sl_fidelity.py#L2783)
...
- whether each family remains in the final long-budget 监督学习阶段 mainline
...
- [run_sl_fidelity.py](/C:/Users/numbe/Desktop/MahjongAI/mortal/run_sl_fidelity.py)
