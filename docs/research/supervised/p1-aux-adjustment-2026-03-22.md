...
> This note records the auxiliary-search adjustment work itself.
> Current mainline context lives in `docs/agent/mainline.md` and `docs/research/supervised-evolution.md`.

## Scope

This note records the reasoning and code changes behind the latest `监督学习阶段 / P1` auxiliary-search adjustments:
...
- [logs/sl_fidelity/sl_fidelity_main/state.json](../../logs/sl_fidelity/sl_fidelity_main/state.json)
...
- [logs/sl_ab/sl_fidelity_main_p1_solo_s20261817](../../logs/sl_ab/sl_fidelity_main_p1_solo_s20261817)
...
Current solo budget ranges in `mortal/run_sl_fidelity.py`:
...
- `mortal/run_sl_fidelity.py`
- `mortal/test_sl_fidelity.py`
...
- `python -m unittest mortal.test_sl_fidelity`
- `python -m py_compile mortal/run_sl_fidelity.py mortal/test_sl_fidelity.py`
...
- keep `监督学习阶段` mainline as `ce_only`
